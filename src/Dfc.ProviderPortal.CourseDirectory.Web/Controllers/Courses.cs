...
namespace Dfc.ProviderPortal.CourseDirectory.Web.Controllers
{
    public class Courses : Controller
    {
        ...
        public IActionResult Summaryedit()
        {
            return View();
        }
        ...
        public IActionResult CourseListfullwidth()
        {
            return View();
        }
        public IActionResult CourseListfullwidth2()
        {
            return View();
        }
        public IActionResult CourseListfullwidth3()
        {
            return View();
        }
        ...
        public IActionResult CourseListfullwidth5()
        {
            return View();
        }
        public IActionResult CourseListfullwidth6()
        {
            return View();
        }
    }
